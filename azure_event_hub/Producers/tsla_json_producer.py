...
def fetch_data_from_api():
    ...
    response = requests.get('https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=TSLA&interval=1min&month=2024-11-24&outputsize=full&apikey=V2SAP2L4HP2N4BBP')
