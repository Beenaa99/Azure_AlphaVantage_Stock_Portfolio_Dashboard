...
def fetch_data_from_api():
    ...
    response = requests.get('https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=NVDA&interval=1min&date=2024-11&outputsize=full&apikey=<APIKEY>')
